node{
  ...
  def ImageName = "subratit/projects-mar-15"
  def ImageTag = "latest"
  ...
  stage('Checkout'){
    ...
    url: 'https://github.com/subrat82/angular-app-kubernetes.git'
  ...
  stage('Docker Build, Push'){
    ...
    stage('Deploy on K8s'){
       ...
       // sh "echo ansible ran successfully"
        ...
        sh "/Users/subrat/docker-desktop-software/kubernetes-project-yaml-files/My-Kubernetes-Demo/kubernetes-examples/angular-app-kubernetes/kubectl apply -f deployment.local.yaml"
